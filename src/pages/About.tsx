...
const About: React.FC = () => {
  ...
  const milestones = [
    {
      ...
      description: 'Started with a vision to revolutionize enterprise software development.',
      icon: <Rocket />,
    },
    {
      year: '2021',
  ...
  const values = [
    ...
    },
    {
      icon: <Security />,
      title: 'Trust',
      description: 'We build secure, reliable systems our clients can depend on.',
    },
    {
      icon: <Analytics />,
      title: 'Impact',
      description: 'We create solutions that drive real business transformation.',
    },
  ];
          ...
          >
            <Box sx={{ textAlign: 'center', mb: 8 }}>
              ...
              <motion.div variants={itemVariants}>
                ...
                >
                  We are a forward-thinking technology company dedicated to developing
                  scalable software solutions that harness the power of artificial
                  intelligence to solve complex enterprise challenges.
                </Typography>
              </motion.div>
            </Box>
          </motion.div>
        ...
        <Grid container spacing={6}>
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              >
                To empower businesses with innovative AI-driven solutions and robust
                DevOps practices that enable digital transformation and sustainable growth.
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              >
                To be the leading provider of intelligent enterprise solutions that
                bridge the gap between cutting-edge technology and practical business
                applications, making advanced AI and DevOps accessible to organizations
                of all sizes.
              </Typography>
            </motion.div>
          </Grid>
